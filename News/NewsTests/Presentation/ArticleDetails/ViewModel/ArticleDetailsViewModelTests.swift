...
final class ArticleDetailsViewModelTests: XCTestCase {
    ...
    private var viewModelWithEmptyDetails: ArticleDetailsViewModel!

    override func setUp() {

        viewModel = ArticleDetailsViewModel(article: Article(id: UUID().uuidString,
        ...
        viewModelWithEmptyDetails = ArticleDetailsViewModel(article: Article(id: UUID().uuidString,
                                                                          author: "David Henderson",
                                                                          title: "An EV Canary in the Coal Mine?",
                                                                          description: nil,
                                                                          url: "https://www.econlib.org/an-ev-canary-in-the-coal-mine/",
    ...
    func testArticleDetailViewModelWithEmptyDetail() {
